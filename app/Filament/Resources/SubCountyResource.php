...
use App\Filament\Resources\SubCountyResource\RelationManagers\WardsRelationManager;
...
class SubCountyResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'Geo-location Management';
    ...
    {
        return [
            'index' => Pages\ManageSubCounties::route('/'),
            'view' => Pages\SubCountyView::route('/{record}'),
        ];
    }
}
