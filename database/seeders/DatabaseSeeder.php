...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // PHASE 3b: Shield Permission Mapping
        // NOTE: Requires Shield permissions to exist (run `php artisan shield:generate --all` first).
        // Skips gracefully if Shield permissions have not been generated yet.
        $this->command->info('🔐 PHASE 3b: Mapping Shield Permissions to Roles...');
        $this->command->info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
